# Схема meta.json (v2) — детальная справка
...
### 3a. Имена персонажей: краткая vs полная форма (КРИТИЧНО)
...
Пример:
```json
{"source": "Sing", "target": "Син", "aliases": [], "category": "person",
 "notes": "first name; see also 'Smedry' (family name)"},
{"source": "Smedry", "target": "Смедри", "aliases": [], "category": "person",
...
```json
{"source": "Sing Sing", "target": "Син-Син",
